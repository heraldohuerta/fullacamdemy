...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { codigo: @option.codigo, descripción: @option.descripción, moneda: @option.moneda, precio: @option.precio } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { codigo: @option.codigo, descripción: @option.descripción, moneda: @option.moneda, precio: @option.precio } }
